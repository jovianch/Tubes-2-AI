    ...
    */
    ...
    public static void main(String[] argv) throws Exception {
        ...
        if (choice == 1) {
            ...
            Classifier kfold = learningKFoldCrossValidation(neural1.instances);
            fullt = (FFNN) learningFullTraining(neural1.instances);
            
            Instance in = createInstanceFromInputUser(neural1.instances,preDisc);
            ...
            for(int k=0; k < fullt.instances.numClasses(); k++){
                System.out.println(x[k]);
            }

            int res = (int) fullt.classifyInstance(in);

            System.out.println("Result: " + fullt.instances.attribute(fullt.instances.classIndex()).value(res));
